(function(n, t) {
    typeof exports == "object" ? module.exports = t(n) : typeof define == "function" && define.amd ? define([], t) : n.LazyLoad = t(n)
})(typeof global != "undefined" ? global : this.window || this.global, function(n) {
    "use strict";
    ...
    typeof define == "function" && define.amd && (n = window);
    const r = {
            src: "data-src",
            srcset: "data-srcset",
            selector: ".lazyload",
        ...
        i = function() {
            let n = {},
                ...
                t = 0,
                u = arguments.length;
            Object.prototype.toString.call(arguments[0]) === "[object Boolean]" && (r = arguments[0], t++);
            let f = function(t) {
                for (let u in t) Object.prototype.hasOwnProperty.call(t, u) && (n[u] = r && Object.prototype.toString.call(t[u]) === "[object Object]" ? i(!0, n[u], t[u]) : t[u])
            };
            for (; t < u; t++) {
                let n = arguments[t];
                f(n)
